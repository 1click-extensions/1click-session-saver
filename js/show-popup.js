...
function oneClickGetPopupHtml(extension) {
  ...
  //   mail = `1click-session-saver@1ce.org`,
  //   	rateLink = `https://chrome.google.com/webstore/detail/aikkdfdhpfjaookbaheghohjnabgnink/reviews`,
  // 	  githubLink = `https://github.com/1click-extensions/1click-session-saver`;
...
.please-rate-title{
	...
	<div class="please-rate-title">What do you think about this extension?</div>
		...
		<div class="please-rate-text">
			...
			If you like 1Click Session Saver <br/><a target=_blank href="https://chrome.google.com/webstore/detail/aikkdfdhpfjaookbaheghohjnabgnink/reviews" >please give us 5-stars</a>
			<br/>
			<div class="addition">
				In addition, If you want to report a bug, or you have a recommendation, please <a href="https://github.com/1click-extensions/1click-session-saver/issues/new">report a public issue</a> or  <a href="mailto:1click-session-saver@1ce.org">Contact us</a>
			</div>
			<div class="skip-wrp"><button type="button" class="btn-popup no-thanks ">Skip</button></div>
		</div>
		<a class="please-rate-github" href="https://github.com/1click-extensions/1click-session-saver">Fork on github</a>
	</div>
	`)
}
